...
TEST(AccountTest_F, TestEmptyAccount)  // AccountTest is already used in another file
{
    Account account;
...
void AccountTestFixture::SetUpTestCase()  // static, should modifie only static members
{
  std::cout << "SetUpTestCase called\n";
}

void AccountTestFixture::TearDownTestCase()  // static, should modifie only static members
{
